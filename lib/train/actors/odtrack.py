...
class ODTrackActor(BaseActor):
    ...
    def forward_pass(self, data):
        ...
        for i in range(self.settings.num_template):
            ...
            template_img_t = data['template_tir'][i].view(-1, *data['template_tir'].shape[2:])
            template_list_tir.append(template_img_t)
        ...
        for i in range(self.settings.num_search):
            ...
            search_img_t = data['search_tir'][i].view(-1, *data['search_tir'].shape[2:])
            search_list_tir.append(search_img_t)
        ...
        out_dict = self.net(template=template_list,
                            template_tir=template_list_tir,
                            search=search_list,
                            search_tir=search_list_tir,
