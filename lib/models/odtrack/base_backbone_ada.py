...
class BaseBackbone(nn.Module):
    ...
    def __init__(self):
        ...
        self.pos_embed_zt = None

        self.pos_embed_xt = None

        self.pos_embed_z_t=None

        self.pos_embed_x_t=None
    ...
    def forward_features(self, z, x,z_t=None, x_t=None,track_query=None, token_type="add"):
